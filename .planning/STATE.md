...
| 260902-i2t | Legend greyed out while the canvas is empty: `data-empty` on the legend card with the InChI box's exact dim rule, rows leave the tab order; explanation card deliberately left at full opacity (it carries the only instruction). cssProbe now handles attribute selectors + comment-preceded rules. 731 tests | 2026-09-02 | 6292eee | [260902-i2t-grey-out-the-legend-while-the-canvas-is-](./quick/260902-i2t-grey-out-the-legend-while-the-canvas-is-/) |
...
- Deployment drift: live assets are dated 2026-08-13; the 8 commits of 2026-08-26,
  the 2026-08-31 italic fix, and quick tasks 260902-gxx/-hrp/-hzh/-i2t are NOT live.
...
Last activity: 2026-09-02 — Quick tasks 260902-gxx (b-layer double-bond model), -hrp (Node pin/lint/audit), -hzh/-i2t (legend inert + greyed out on empty canvas). HEAD 6292eee
